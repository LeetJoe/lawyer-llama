...
if __name__ == "__main__":
    ...
    tokenizer = LlamaTokenizer.from_pretrained('/data1/neosong/models/huggingface/pkupie/lawyer-llama-13b-decoded')
    model = LlamaForCausalLM.from_pretrained('/data1/neosong/models/huggingface/pkupie/lawyer-llama-13b-decoded', device_map="auto", load_in_8bit=True)
    ...
    demo.queue()
    demo.launch(share=True, server_port=args.port, server_name='127.0.0.1')
